...
上图中我们将Pfaffian记作了$E_\epsilon\equiv\mathrm{Pf'}\Psi(\epsilon)$。这意味着不同的理论之间存在千丝万缕的关联，后面KLT、BCJ对偶这一点会更加明显。
...
文献[^10]把无质量QCD的$N^pMHV$振幅树图完全写出来了，放在这里感受一下：
...
## 任意点
证明的思路就是树图的任意点振幅都可以用BCFW递推的方式用低点的振幅去构造，那么我们只需要证明CHY公式满足振幅的BCFW递推，联合上面的$n=3,4$的证明，证明就完成了。证明步骤follow文献[^11]。
