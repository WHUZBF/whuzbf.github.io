...
由于本站公式不知为何在equation环境下无法自动处理overflow问题，只能手动改css，所以我为了方便手机端阅读直接去掉了一些长公式的equation环境，唯一的缺点就是无法公式标号，其它均不变。
...
\begin{equation}
\begin{aligned}
    G_0\equiv \frac{1}{z-H_0} &=\sum_a \frac{P^{(0)}_a}{z-E^{(0)}_a},
    \\ \quad G\equiv \frac{1}{z-H} &=\sum_a \frac{P_a}{z-E_a}
\end{aligned}
\end{equation}
$$
...
$$
\begin{aligned}
(H-E_a^{(0)})P&=\lambda P_0VP_0\\&+\lambda^2\left(P_0VP_0V\frac{Q_0}{a}+P_0V\frac{Q_0}{a}VP_0+\frac{Q_0}{a}VP_0VP_0\right)+\ldots
\end{aligned}
$$
