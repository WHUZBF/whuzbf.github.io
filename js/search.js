...
var tmpDiv = document.createElement('div'),
    // 这里是为了让搜索结果的title也能点击跳转
    tmpTitle=document.createElement('a');
...
// 设置css样式
tmpTitle.setAttribute('style', 'color:#488de1');
...
function searchMatching(arrTitles, arrContents, input) {
    ...
    for (i = 0; i < arrResults.length; i++) {
        var itemDiv = tmpDiv.cloneNode(true);
        var itemTitleDiv = tmpTitle.cloneNode(true);    // 这里是为了让搜索结果的title也能点击跳转
        ...
        // 这里是为了让搜索结果的title也能点击跳转
        itemTitleDiv.href = arrLinks[indexItem[i]];
